...
- [ ] Explain what a token is used for.
      ...
      A token is like a key that lets the server be accessed

- [ ] What steps can you take in your web apps to keep your data secure?

      Use tokens for authoriaztion.  Use something like vercel  

- [ ] Describe how web servers work.

    Web servers host files and make them accessable with HTTP
